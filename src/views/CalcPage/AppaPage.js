            ...
            <div className="top">
                ...
                <div className="top-input">
                    <div className="appa">
                            ...
                            {busType ?
                                <div>
                                    ...
                                    <select className="appa-select-count" onChange={e => setTransport(e.target.value)}>
                                        <option value="1.44" selected>Մինչև 17 (առանց վարորդի)</option>
                        ...
                        {transport == 1 ?
                            <div>
                                ...
                                <select className="appa-select-type" onChange={e => setGoal(e.target.value)}>
                                    <option value="1" selected>Անձնական</option>
                        ...
                        <br />
                        <select className="appa-select-date" onChange={e => setBM(e.target.value)}>
                            ...
                            <option value="1" selected>Դաս 10</option>
